document.addEventListener("DOMContentLoaded", async () => {
  ...
  const saveRanking = async (shouldShowIndicator = true) => {
    ...
    try {
      ...
      toast.textContent = "Failed to save your changes";
  ...
  async function confirmRanking() {
    ...
    if (Object.keys(userRanking).length !== objects.length) {
      ...
      const toast = document.createElement("div");
      toast.textContent = "Please rank all items before confirming";
      toast.style.position = "fixed";
      toast.style.bottom = "20px";
      toast.style.left = "50%";
      toast.style.transform = "translateX(-50%)";
    ...
    showConfirmDialog(
      ...
      async () => {
        ...
        if (success) {
          ...
          // Show success toast
          const toast = document.createElement("div");
          toast.textContent = "Your ranking has been confirmed successfully!";
          toast.style.position = "fixed";
          toast.style.bottom = "20px";
          toast.style.left = "50%";
          toast.style.transform = "translateX(-50%)";
          ...
          // Show error toast
          const toast = document.createElement("div");
          toast.textContent = "Failed to confirm ranking. Please try again.";
          toast.style.position = "fixed";
          toast.style.bottom = "20px";
          toast.style.left = "50%";
          toast.style.transform = "translateX(-50%)";
  ...
  // Handle touch-based drag and drop
  function setupTouchDragAndDrop(element) {
    if (isConfirmed) return;
  ...
  function createRankItem(object, position) {
    ...
    // Setup touch drag and drop
    setupTouchDragAndDrop(item);
